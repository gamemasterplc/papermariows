...
s16 PopupWorldStartX[] = {
    [POPUP_MENU_USE_ITEM]          (SCREEN_WIDTH-180),
    [POPUP_MENU_SWITCH_PARTNER]    (SCREEN_WIDTH-180),
    [POPUP_MENU_THROW_AWAY_ITEM]   (SCREEN_WIDTH-179),
    [POPUP_MENU_TRADE_FOR_BADGE]   (SCREEN_WIDTH-196),
    [POPUP_MENU_UPGRADE_PARTNER]   (SCREEN_WIDTH-186),
    [POPUP_MENU_SELL_ITEM]         (SCREEN_WIDTH-201),
    [POPUP_MENU_CHECK_ITEM]        (SCREEN_WIDTH-179),
    [POPUP_MENU_CLAIM_ITEM]        (SCREEN_WIDTH-179),
    [POPUP_MENU_READ_LETTER]       (SCREEN_WIDTH-212),
    [POPUP_MENU_TAKE_FROM_CHEST]   (SCREEN_WIDTH-179),
    [POPUP_MENU_READ_DIARY_PAGE]   (SCREEN_WIDTH-188),
    [POPUP_MENU_READ_POSTCARD]     (SCREEN_WIDTH-188),
    [POPUP_MENU_USEKEY]            (SCREEN_WIDTH-179),
    [POPUP_MENU_POST_OFFICE]       (SCREEN_WIDTH-180),
};
