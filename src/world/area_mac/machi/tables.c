...
GameVarRange N(GameFlagTable)[] = {
    ...
    VAR_RANGE_FLAG("GSWF TIK",   GF_Unused_TIK_00,                GF_KGR_EraseDarkness,                GF_Unused_TIK_33),
    VAR_RANGE_FLAG("GSWF KGR",   GF_KGR_EraseDarkness,            GF_KKJ14_OpenedPassage,          GF_KGR_EraseDarkness),
